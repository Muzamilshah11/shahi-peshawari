...
<div class="container">
    ...
    <!-- Products Grid -->
    <div class="product-grid" id="modernGrid" style="margin-bottom:48px;">
    ...
    db.ref('products').on('value', function(snap) {
        try {
            ...
            Object.keys(fbProducts).forEach(function(id) {
                ...
                html += '<div class="product-card" data-id="' + id + '" data-name="' + safeName + '" data-cat="modern" style="border:1px solid rgba(9,132,227,.15);position:relative;">'
                    ...
                    + '<div class="card-body"><span class="card-cat">modern</span><h3 class="card-title">' + safeName + '</h3><div style="margin:3px 0">' + stars + '</div>'
