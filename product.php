    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="orderForm" onsubmit="return false;">
                ...
                <div class="form-group">
                    <label><i class="fas fa-map-marker-alt" style="color:var(--blue)"></i> Delivery Address (auto-detected)</label>
                    <input type="text" id="oAddress" placeholder="Detecting location...">
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>City</label>
    ...
    navigator.geolocation.getCurrentPosition(pos => {
        fetch(`https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${pos.coords.latitude}&longitude=${pos.coords.longitude}&localityLanguage=en`)
            .then(r => r.json()).then(data => {
                ...
                document.getElementById('oCity').value = [city, state].filter(Boolean).join(', ');
            }).catch(() => {});
    }, () => {});
}
